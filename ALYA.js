...
const sayiEmojiler = {
  0: "<a:s_0:801454779900493855>",
  1: "<a:s_1:801454809831440395>",
  2: "<a:s_2:801454838239068181>",
  3: "<a:s_3:801454870044737607>",
  4: "<a:s_4:801454897576280136>",
  5: "<a:s_5:801454923598004255>",
  6: "<a:s_6:801454955965710366>",
  7: "<a:s_7:801454987128340481>",
  8: "<a:s_8:801455016615084083>",
  9: "<a:s_9:801455043949101076>"
};
...
client.emojiler = {
  onay: "768393534856232982",
  iptal: "768393534856232982",
  cevrimici: "768393534856232982",
  rahatsizetmeyin: "768393534856232982",
  bosta: "768393534856232982",
  gorunmez: "768393534856232982",
  erkekEmoji: "768393534856232982",
  kizEmoji: "768393534856232982",
  gif1: "768393534856232982",
  gif2: "768393534856232982",
  gif3: "768393534856232982",
  gif4: "768393534856232982"
};
...
const iltifatlar = ["Yaşanılacak en güzel mevsim sensin.",
...
if(message.channel.id !== "697492032364740648") return;
let ars = db.get("iltifatss");
await db.add("iltifatss", 1)
if(ars >= 50)/*değiştirebilirsin*/ {
db.delete("iltifatss");
const iltifatlar1 = Math.floor(Math.random() * ((iltifatlar).length - 1) + 1);
message.reply(`${(iltifatlar)[iltifatlar1]}`)
}
