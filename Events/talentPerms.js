...
client.komutlar = [
  ...
  {isim: "ekip", rol: "754824768557023253"},
  {isim: "terapist", rol: "689184135960461399"},
  {isim: "rehber", rol: "626907350602743838"},
  {isim: "u1", rol: "810110111615287296"},
  {isim: "u2", rol: "810110484204224562"},
  {isim: "uyarı3", rol: "611937764820385812"},
  {isim: "streamer", rol: "696703917664370849"},
  {isim: "yetkilial1", rol: "754688290304819260"},
  {isim: "yetkilial2", rol: "765672747278794784"},
  {isim: "yetkilial3", rol: "765670893636419594"},
...
module.exports = (message) => {
  ...
  if (komut && (komut.isim === "yetkilial1" || komut.isim === "yetkilial2" || komut.isim === "yetkilial3")) {
    ...
    uye.roles.add([komut.rol, "754688290304819260", "", ""]);
